...
public static class MessagingServiceExtensions
{
    ...
    public static IServiceCollection AddMongoMessagingDataStore(this IServiceCollection services, IConfiguration config, Action<MongoMessagingDataOptions>? configure = null,
